<template>
  <div class="f2-main-content" style="    padding-top: 43px;">
    <mt-header :title="$mt('得分统计')" style="margin-bottom: 10px;" class="mint-header-f">
      <mt-button slot="left" icon="back" @click="goBack()">{{$mt('返回')}}</mt-button>
    </mt-header>
    <div class="main overflow-scroll">
      <div class="chart-item">
        <h3 class="tit">{{$mt('资源得分情况')}}</h3>
