<template>
  <div class="bnake-end-wrap popup-scroll">
    <mt-header :title="$mt('已结束班课')" class="mint-header-f">
    ...
    >
      <div v-for="(item,selindex) in EndCurbankes" :key="selindex">
        <BankeSimple :classitem="item" class="bitem-shadow"   :isCreate="false" :end="true" @click.native="bankeclick(item)"></BankeSimple>
      </div>
