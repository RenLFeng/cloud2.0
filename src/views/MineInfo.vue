<template>
    <div>
        ...
        <div>
            ...
            <mt-cell :title="$mt('角色')">
                <span class="mineinfospan">{{$mt(userrole)}}</span>
            </mt-cell>
        </div>
        ...
        <mt-popup v-model="popupVisible3" position="right" class="mint-popup-3" :modal="false">
            <mt-header :title="$mt('编辑头像')">
                ...
                <mt-button icon="back" slot="left" @click="popupVisible3 = false">{{$mt('返回')}}</mt-button>
